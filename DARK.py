...
class crack:
	...
	def main(self,fl):
		try:
			...
			self.ko+=1
			print("\r\033[1;97m[ CRACK ]\033[1;97m %s/%s \033[1;92mOK : %s \033[1;93mCP : %s\033[1;97m"%(self.ko,len(self.fl),len(self.ada),len(self.cp)), end=' ');sys.stdout.flush()
		except:
			self.main(fl)
